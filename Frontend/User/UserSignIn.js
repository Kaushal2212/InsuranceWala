  ...
  return (
    <div className="signin-wrapper"> {/* Added wrapper for centering */}
      <div className="signin-container">
        ...
        <p className="signin-description">Sign up to manage your insurance policies online.</p>
        ...
        Don't have an account? <a href="/register" className="signin-link">Register Here</a>
        </p>
      </div>
    </div>
  );
